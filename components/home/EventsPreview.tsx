...
export function EventsPreview({ events }: { events: Event[] }) {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="hero-glow w-[350px] h-[350px] bg-indigo-600 bottom-0 left-1/4 opacity-10" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 flex flex-col items-center justify-center flex-shrink-0">
