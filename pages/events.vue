  ...
  <div>
    ...
    <section class="bg-terra-900 pt-32 pb-20 relative overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
        <span class="section-label !text-gold-400 mb-4" style="--section-color:#c9a84c; animation: fadeIn 0.5s ease both">Kalender</span>
        ...
        <p class="text-white/60 mt-4 max-w-md" style="animation: fadeUp 0.8s 0.25s ease both">Mød os til gudstjenester, bøn, ungdomsmøder og meget mere.</p>
      </div>
    </section>
