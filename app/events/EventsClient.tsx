    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-slate-300 text-lg">Alle gudstjenester, møder og arrangementer på ét sted</p>
          </motion.div>
        </div>
      </section>

      {/* Filters */}
      <section className="py-8 bg-slate-900/80 border-b border-white/5 sticky top-20 z-30 backdrop-blur-xl">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4 mb-4">
                          <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${catGradients[event.category] || catGradients.general} flex flex-col items-center justify-center flex-shrink-0 shadow-xl`}>
                            <span className="text-white text-xs font-bold">
                              {date.toLocaleDateString("da-DK", { month: "short" })}
                            </span>
                            <span className="text-white text-xl font-black leading-none">{date.getDate()}</span>
                          </div>
          ...
          {past.length > 0 && (
            <div>
              <h2 className="text-2xl font-bold text-slate-500 mb-8">Tidligere</h2>
