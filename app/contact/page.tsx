      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-slate-300 text-lg">Vi hører gerne fra dig — skriv, ring eller mød os søndag</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-8">Kontaktoplysninger</h2>
                ...
                <div className="space-y-3 text-sm">
                  {[
                    ...
                    <div key={s.day} className="flex items-center justify-between">
                      ...
                      <span className="text-blue-400 font-medium">{s.time}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <h2 className="text-2xl font-bold text-white mb-8">Send os en besked</h2>
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <div className="glass-card overflow-hidden rounded-2xl h-64 flex items-center justify-center relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 to-slate-900/80" />
              <div className="relative z-10 text-center">
                <MapPin className="w-10 h-10 text-blue-400 mx-auto mb-3" />
                <p className="text-white font-bold text-lg">Kirkevej 10, 9700 Brønderslev</p>
                <a
                  href="https://maps.google.com/?q=Kirkevej+10+9700+Brønderslev"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-3 inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 text-sm underline"
                >
                  Åbn i Google Maps
                </a>
              </div>
